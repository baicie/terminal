export default {
  ...
  'shortcuts.description': 'Tous les raccourcis disponibles. Appuyez sur ? ou Cmd/Ctrl + / à tout moment.',
  ...
  'terminal.windowUnfocused': 'Fenêtre inactive — la saisie est envoyée au terminal en arrière-plan',

  // Settings
  'settings.copyOnSelect': 'Copier à la sélection',
  'settings.copyOnSelectDesc': 'Copier automatiquement le texte sélectionné dans le presse-papiers',
  'settings.pasteOnMiddleClick': 'Coller au clic du milieu',
  'settings.pasteOnMiddleClickDesc': 'Coller le contenu du presse-papiers via le bouton central de la souris',
  'settings.allowProposedApi': 'Autoriser les API proposées',
  'settings.allowProposedApiDesc': 'Activer les API expérimentales de xterm.js (requises par le module image)',
  'settings.desktopSection': 'Expérience bureau',
  'settings.minimizeToTray': 'Minimiser dans la barre d\'état à la fermeture',
  'settings.minimizeToTrayDesc': 'Masquer la fenêtre au lieu de quitter ; l\'application continue dans la barre d\'état',
  'settings.nativeNotifications': 'Notifications système natives',
  'settings.nativeNotificationsDesc': 'Afficher des notifications OS à la déconnexion ou à la fin d\'une tâche longue',
