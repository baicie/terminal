export default {
  ...
  'settings.never': '从未',
  'settings.restoreMode': '恢复模式',
  'settings.restoreFromServer': '从服务器恢复',
  'settings.previewChanges': '预览更改',
  'settings.refreshPreview': '刷新预览',
  'settings.conflictDetails': '冲突详情',
  'settings.restoring': '恢复中...',
  'settings.noBackupFound': '未找到备份',
  'settings.noBackupFoundDesc': '服务器上没有可恢复的备份数据',
  'settings.syncSuccess': '同步成功',
  'settings.syncFailed': '同步失败',
  'settings.restoreSuccess': '恢复成功',
  'settings.restoreFailed': '恢复失败',
  'settings.serviceModeEnabled': '服务模式已启用',
  'settings.serviceModeEnabledDesc':
    '您的数据将与配置的存储服务同步。请先点击"测试连接"以验证服务可访问。',
  'settings.enterEndpoint': '请输入端点 URL 以测试连接',
  'settings.connectionServiceNotReachable': '服务已响应但状态不健康',
  'settings.connectionUploadFailed': '向服务器上传数据失败',
  'settings.connectionNoBackupFound': '服务器上没有可恢复的备份数据',
  ...
  'settings.showApiToken': '显示 API 令牌',
  'settings.hideApiToken': '隐藏 API 令牌',
  ...
  'settings.enterEndpointTeam': '请输入服务器端点',
