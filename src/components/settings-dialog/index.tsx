          ...
          <TabsContent value="storage" className="space-y-6 py-4">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <HardDrive className={`h-6 w-6 ${settings.dataStorageMode === "local" ? "text-primary" : "text-muted-foreground"}`} />
                  <span className="text-sm font-medium">Local</span>
                  <span className="text-xs text-muted-foreground">SQLite on this device</span>
                </button>
                <button
                  type="button"
                  className={`
                ...
                >
                  <Server className={`h-6 w-6 ${settings.dataStorageMode === "service" ? "text-primary" : "text-muted-foreground"}`} />
                  <span className="text-sm font-medium">Service</span>
                  <span className="text-xs text-muted-foreground">Sync via remote server</span>
                </button>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateSetting("syncServiceType", value as "webdav" | "s3" | "custom")}
                >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder={settings.syncServiceType === "s3" ? "AKIAIOSFODNN7EXAMPLE" : "Username"}
              ...
              <div className="space-y-2">
                <Label htmlFor="syncServiceToken">
                  {settings.syncServiceType === "s3" ? "Secret Access Key" : settings.syncServiceType === "webdav" ? "Password / Token" : "API Token"}
                </Label>
                <div className="relative">
                  <Input
                    id="syncServiceToken"
                    type={showTokenVisible ? "text" : "password"}
                    placeholder={settings.syncServiceType === "s3" ? "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY" : "••••••••"}
            ...
            <div className="flex gap-2">
              <Button variant="outline" className="flex-1" disabled={!settings.syncServiceEndpoint}>
                <Server className="h-4 w-4 mr-2" />
                Test Connection
              </Button>
              <Button variant="outline" className="flex-1" disabled={!settings.syncServiceEndpoint} onClick={handleExport}>
